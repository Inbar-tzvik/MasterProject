    ...
    <div class="container">
      ...
      <?php
        ...
        if($bolsql_course == true && $bolHTML == true && $bolPYTHON == true && $bolUI_UX == true &&  $bolSAP_ERP == true){
                echo "<br> ";
              echo " <p class='text-center'> אתה בדרך הנכונה ! יש לך את כל הציונים המתאימים בקורסים הנדרשים </p>";
                    }
        else{
                echo "<br> ";
                echo "<p class='text-center'> הקורסים הבאים או שהציון שלך לא מספיק עבורם או שמומלץ שתעשה את קורסים אלו</p>";
                 echo "<br> ";
